use utf8;
package Catalogue::Schema::Result::SystemSupplier;
...
=head1 TABLE: C<system_supplier>

=cut

__PACKAGE__->table("system_supplier");
...
__PACKAGE__->set_primary_key("system_id", "supplier_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2NYFk2gzeLJFuRcRhuSHGA
