use utf8;
package Catalogue::Schema::Result::ApprovalService;
...
=head1 TABLE: C<approval_service>

=cut

__PACKAGE__->table("approval_service");
...
=head2 approval_service_histories

Type: has_many

Related object: L<Catalogue::Schema::Result::ApprovalServiceHistory>

=cut

__PACKAGE__->has_many(
  "approval_service_histories",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rtTsoMxsl1dSColZ9hpkrw
