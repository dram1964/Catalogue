use utf8;
package Catalogue::Schema::Result::SystemErid;
...
=head1 TABLE: C<system_erid>

=cut

__PACKAGE__->table("system_erid");
...
__PACKAGE__->set_primary_key("system_id", "er_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:E3gB7GSCwHbQdQxbreLx3w
