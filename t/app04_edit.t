...
$test01->get_ok("/databases/id/" . $db->db_id . "/edit_description", 
...
$test02->get_ok("/databases/id/" . $db->db_id . "/edit_description", 
...
$test03->get_ok("/databases/id/" . $db->db_id . "/edit_description", 
...
$test01->get_ok("/schemas/id/" . 
	$sch->sch_id . "/" . $sch->db_id . "/edit_current", 
	"test01 request to schemas edit current");
$test01->content_contains('Permission Denied', 
	"test01 Denied schemas edit current");

$test02->get_ok("/schemas/id/" . 
	$sch->sch_id . "/" . $sch->db_id . "/edit_current", 
	"test01 request to schemas edit current");
...
$test01->get_ok("/schemas/id/" . 
	$sch->sch_id . "/" . $sch->db_id . "/edit_description", 
