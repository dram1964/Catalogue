...
$test01->get_ok("http://localhost/login?username=test01&password=mypass", 
	"Login test01");
$test02->get_ok("http://localhost/login?username=test02&password=mypass", 
	"Login test01");
$test03->get_ok("http://localhost/login?username=test03&password=mypass", 
	"Login test01");

$test01->get_ok("http://localhost/databases/id/8/1/edit_description", 
...
$test02->get_ok("http://localhost/databases/id/8/1/edit_description", 
...
$test03->get_ok("http://localhost/databases/id/8/1/edit_description", 
...
$test01->get_ok("http://localhost/databases/id/8/1/edit_current", 
...
$test01->get_ok("http://localhost/datasets/id/1/edit", 
	"test01 request to datasets edit");
$test01->content_contains('Permission Denied', 
	"test01 Denied datasets edit");

$test02->get_ok("http://localhost/datasets/id/1/edit", 
...
$test01->get_ok("http://localhost/schemas/id/13/8/edit_current", 
	"test01 request to schemas edit current");
$test01->content_contains('Permission Denied', 
	"test01 Denied schemas edit current");

$test02->get_ok("http://localhost/schemas/id/13/8/edit_current", 
...
$test01->get_ok("http://localhost/schemas/id/13/8/edit_description", 
	"test01 request to schemas edit description");
$test01->content_contains('Permission Denied', 
	"test01 Denied schemas edit description");

$test02->get_ok("http://localhost/schemas/id/13/8/edit_description", 
...
$test01->get_ok("http://localhost/systems/id/2/edit", 
	"test01 request to systems edit");
$test01->content_contains('Permission Denied', 
	"test01 Denied systems edit");

$test02->get_ok("http://localhost/systems/id/2/edit", 
...
$test01->get_ok("http://localhost/tables/id/38/edit_current", 
	"test01 request to tables edit current");
$test01->content_contains('Permission Denied', 
	"test01 Denied tables edit current");

$test02->get_ok("http://localhost/tables/id/38/edit_current", 
...
$test01->get_ok("http://localhost/tables/id/38/edit_description", 
	"test01 request to tables edit_description");
$test01->content_contains('Permission Denied', 
	"test01 Denied tables edit_description");

$test02->get_ok("http://localhost/tables/id/38/edit_description", 
...
$test01->get_ok("http://localhost/tasks/id/1/edit", 
	"test01 request to tasks edit");
$test01->content_contains('Permission Denied', 
	"test01 Denied task edit");

$test02->get_ok("http://localhost/tasks/id/1/edit", 
...
$test03->get_ok("http://localhost/datasets/id/2/edit", 
