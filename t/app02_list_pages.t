...
$ua1->get_ok("/systems/list", "'test01' systems list");
$ua1->title_is('System List', "test01 systems list title");
...
$ua1->title_is('System Databases', "test01 systems list title");
...
$ua1->get_ok("/systems/list", "Return to systems list");
